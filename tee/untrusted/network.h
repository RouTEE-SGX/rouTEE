...
#define OP_LOCAL_PRIMARY_ROUTEE 99
#define OP_LOCAL_SET_ROUTING_FEE_ROUTEE 100
#define OP_LOCAL_SET_ROUTING_FEE_ADDRESS_ROUTEE 101
#define OP_LOCAL_CREATE_CHANNEL_ROUTEE 102
#define OP_LOCAL_PRINT_STATE_ROUTEE 103
#define OP_LOCAL_SETTLE_BALANCE_ROUTEE 104
#define OP_LOCAL_MAKE_SETTLE_TX_ROUTEE 105
#define OP_LOCAL_DO_MULTIHOP_PAYMENT_ROUTEE 106
#define OP_LOCAL_MAKE_OWNER_KEY_ROUTEE 107
#define OP_LOCAL_LOAD_OWNER_KEY_ROUTEE 108
#define OP_LOCAL_SETUP_DEPOSIT_REQUEST_ROUTEE 109
#define OP_LOCAL_INSERT_BLOCK_ROUTEE 110
...
struct LocalSetRoutingFeeRouteeMsg {
    char msg_op[1];
    unsigned long long routing_fee;
};

struct LocalSetRoutingFeeAddressRouteeMsg {
    char msg_op[1];
...
struct LocalSettleBalanceRouteeMsg {
    char msg_op[1];
    char my_address[BITCOIN_ADDRESS_LEN];
};

struct LocalDoMultihopPaymentRouteeMsg {
    char msg_op[1];
    char sender_address[BITCOIN_ADDRESS_LEN];
    char receiver_address[BITCOIN_ADDRESS_LEN];
    unsigned long long amount;
    unsigned long long routing_fee;
};
